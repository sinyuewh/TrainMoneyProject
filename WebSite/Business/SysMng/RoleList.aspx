            ...
            <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            <jasp:SecurityPanel ID="SecurityPanel1" runat="server">
                                ...
                                <AssemblePara AssembleFile="WebFrame.DLL" ClassLibName="WebFrame.Designer.JRoleBU" MethodName="DeleteRole"  />
                                <ParaItems>
                                    <jasp:ParameterItem ParaName="SelDocument" DataName="RoleID" ParaType="RequestForm" />
                                </ParaItems>
                ...
                <table id="SearchTable" runat="server" class="InfoSearch">
                    <tr>
                        ...
                        <td>
                            <jasp:JTextBox ID="rolename" runat="server" AutoFillValue="true" Width="100" />
                        </td>
                        <td style="text-align: right">
                            备注：
                        </td>
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp; &nbsp;<jasp:JButton ID="butSearch" Text="查询" JButtonType="SearchButton"
                                ...
                                <SearchPara SearchControlList="rolename,remark,modelid" />
                            </jasp:JButton>
                            &nbsp;
                            <jasp:JButton ID="JButton1" Text="取消" runat="server" JButtonType="SearchButton" DataSourceID="Data1"
                                UseSubmitBehavior="false">
                                <SearchPara SearchControlList="rolename,remark,modelid" IsCancelSearch="true" />
                            </jasp:JButton>
                        </td>
                    </tr>
                </table>
                    ...
                    <asp:Repeater ID="repeater1" runat="server" DataSourceID="Data2" EnableViewState="false">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="Data">
                                    <a href='RoleDetail.aspx?RoleID=<%# Eval("roleid")%>'>
                                        <%#Eval("roleid") %></a>
                                </td>
                                <td class="Data">
                                    <%#Eval("rolename") %>
                                ...
                                <td class="Data">
                                    <input id="SelDocument" name="SelDocument" type="checkbox" value='<%#Eval("roleid") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
