...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:UpdatePanel ID="update1" runat="server">
            <ContentTemplate>
                <jasp:JDataSource ID="Data2" runat="server" JType="Table" SqlID="JItem" PageSize="15"
                    OrderBy="num">
                </jasp:JDataSource>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            <jasp:SecurityPanel ID="SecurityPanel1" runat="server">
                                ...
                                <AssemblePara AssembleFile="WebFrame.DLL" ClassLibName="WebFrame.Designer.JItemBU" MethodName="DeleteItem" />
                                <ParaItems>
                                    <jasp:ParameterItem ParaName="SelDocument" DataName="ItemName" ParaType="RequestForm" />
                                </ParaItems>
                ...
                <table id="SearchTable" runat="server" class="InfoSearch">
                    <tr>
                        ...
                        <td>
                            <jasp:JTextBox ID="author" runat="server" AutoFillValue="true" Width="100" />
                        </td>
                        <td style="text-align: right">
                            备注：
                        </td>
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp; &nbsp;<jasp:JButton ID="butSearch" Text="查询" JButtonType="SearchButton"
                                ...
                                <SearchPara SearchControlList="author,remark,modelid" />
                            </jasp:JButton>
                            &nbsp;
                            <jasp:JButton ID="JButton1" Text="取消" runat="server" JButtonType="SearchButton" DataSourceID="Data1"
                                UseSubmitBehavior="false">
                                <SearchPara SearchControlList="author,remark,modelid" IsCancelSearch="true" />
                            </jasp:JButton>
                        </td>
                    </tr>
                </table>
                    ...
                    <asp:Repeater ID="repeater1" runat="server" DataSourceID="Data2" EnableViewState="false">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="Data">
                                    <a href='ItemDetail.aspx?ItemName=<%# Eval("itemName")%>'>
                                        <%#Eval("itemname") %></a>
                                </td>
                                <td class="Data">
                                    <%#Eval("author") %>
                                ...
                                <td class="Data">
                                    <%#Eval("kind").ToString()=="0" ? "用户条目":"系统条目" %>
                                </td>
                                <td class="Data">
                                    <%#Eval("remark") %>
                                </td>
                                <td class="Data">
                                    <input id="SelDocument" name="SelDocument" type="checkbox" value='<%#Eval("itemName") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
