...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:UpdatePanel ID="update1" runat="server">
            <ContentTemplate>
                <jasp:JDataSource ID="Data2" runat="server" JType="Table" SqlID="JStrInfo" PageSize="15"
                    OrderBy="num">
                </jasp:JDataSource>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            <jasp:SecurityPanel ID="SecurityPanel1" runat="server">
                                ...
                                <SimpleActionPara TableName="JstrInfo" ButtonType="DeleteData" />
                                <ParaItems>
                                    <jasp:ParameterItem ParaName="SelDocument" DataName="StrID" ParaType="RequestForm" />
                                </ParaItems>
                    ...
                    <asp:Repeater ID="repeater1" runat="server" DataSourceID="Data2" EnableViewState="false">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="Data">
                                    <a href='StrInfoDetail.aspx?StrID=<%# Eval("strid")%>'>
                                        <%#Eval("strid") %></a>
                                </td>
                                <td class="Data">
                                    <%#Eval("author") %>
                                ...
                                <td class="Data">
                                    <input id="SelDocument" name="SelDocument" type="checkbox" value='<%#Eval("strid") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
