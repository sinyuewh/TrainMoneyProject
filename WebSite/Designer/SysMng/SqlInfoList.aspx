...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:UpdatePanel ID="update1" runat="server">
            <ContentTemplate>
                <jasp:JDataSource ID="Data2" runat="server" JType="Table" SqlID="JSqlInfo" PageSize="15"
                    OrderBy="num">
                </jasp:JDataSource>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            <jasp:SecurityPanel ID="SecurityPanel1" runat="server">
                                ...
                                <SimpleActionPara TableName="JSqlInfo" ButtonType="DeleteData" />
                                <ParaItems>
                                    <jasp:ParameterItem ParaName="SelDocument" DataName="SqlID" ParaType="RequestForm" />
                                </ParaItems>
                    ...
                    <asp:Repeater ID="repeater1" runat="server" DataSourceID="Data2" EnableViewState="false">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="Data">
                                    <a href='SqlInfoDetail.aspx?SqlID=<%# Eval("sqlid")%>'>
                                        <%#Eval("sqlid") %></a>
                                </td>
                                <td class="Data">
                                    <%#Eval("author") %>
                                ...
                                <td class="Data">
                                    <input id="SelDocument" name="SelDocument" type="checkbox" value='<%#Eval("sqlid") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
