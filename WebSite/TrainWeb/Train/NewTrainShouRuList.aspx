<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="NewTrainShouRuList.aspx.cs" Inherits="WebSite.TrainWeb.Train.TrainShouRuList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display: none">你当前的位置：</span>财务数据模型-担当车收入
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                    ...
                                                    <td width="200" style="text-align: right">
                                                        <table width="90%" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td class="STYLE1">
                                                                    <div align="center">
                                                                        <a href="javascript:ImportDataToSystem();">导入数据</a>
                                                                    </div>
                                                                </td>
                                                                <td class="STYLE1">
                                                                    <div align="center">
        ...
        <tr>
            <td>
                <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="NEWTRAINSHOUROU"
                    PageSize="15" OrderBy="byear desc,bmonth desc,TrainName,num" >
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='NewTrainShouRuDetail.aspx?num=<%#Eval("num")%>'>
