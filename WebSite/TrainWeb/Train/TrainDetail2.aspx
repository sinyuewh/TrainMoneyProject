            ...
            <td>
                            ...
                            <jasp:JDetailView ID="DetailView1" runat="server" DataSourceID="Data1" ControlList="*">
                                <table class="DetailTable" cellspacing="1" cellpadding="0" style="width: 80%; margin-left: 15px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data"> <!--增加车型的影响2013年3月13日-->
                                            <jasp:JDropDownList ID="TrainType" runat="server">
                                                <asp:ListItem Text="CRH2A" Value="CRH2A"></asp:ListItem>
                                                <asp:ListItem Text="CRH2E" Value="CRH2E"></asp:ListItem>
                                                <asp:ListItem Text="CRH2C" Value="CRH2C"></asp:ListItem>
                                                <asp:ListItem Text="CRH380A" Value="CRH380A"></asp:ListItem>
                                                <asp:ListItem Text="CRH380AL" Value="CRH380AL"></asp:ListItem>
                                                <asp:ListItem Text="CRH380B" Value="CRH380B"></asp:ListItem>
                                                <asp:ListItem Text="CRH380BL" Value="CRH380BL"></asp:ListItem>
                                            </jasp:JDropDownList>
                                        </td>
                                        <td class="Caption">
                                            起点终点
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JDropDownList ID="HighTrainBianZhu" runat="server">
                                                <asp:ListItem Text="单组" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="重联" Value="1"></asp:ListItem>
                                            </jasp:JDropDownList>
                                        </td>
                                        <td class="Caption">
                                            线路配置<br />
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data">
                                            ...
                                            <jasp:JTextBox ID="TRAINBIGKIND" runat="server" Visible="false" Text="1"></jasp:JTextBox>
                ...
                <table width="90%" style="display: none">
                    ...
                    <tr>
                        ...
                        <td>
                            <jasp:JTextBox ID="YinZuo" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="YinZuoPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="RUANZUO" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="RUANZUOPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="OPENYINWO" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="OPENYINWOPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="CLOSEYINWO" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="CLOSEYINWOPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="RUANWO" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="RUANWOPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="ADVANCERUANWO" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="ADVANCERUANWOPrice" runat="server" Width="50" Visible="false"
                                Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="CANCHE" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="CANCHEPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="FADIANCHE" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="FADIANCHEPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <jasp:JTextBox ID="SHUYINCHE" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                        <td>
                            <jasp:JTextBox ID="SHUYINCHEPrice" runat="server" Width="50" Visible="false" Text="0"></jasp:JTextBox>
                        </td>
                    </tr>
                </table>
                <jasp:JTextBox ID="Line4" runat="server" Width="50" Text="0" Visible="false"></jasp:JTextBox>
                <jasp:JTextBox ID="Line6" runat="server" Width="50" Text="0" Visible="false"></jasp:JTextBox>
                  <jasp:JTextBox ID="Line8" runat="server" Width="50" Text="0" Visible="false"></jasp:JTextBox>
            </td>
        </tr>
        <tr>
