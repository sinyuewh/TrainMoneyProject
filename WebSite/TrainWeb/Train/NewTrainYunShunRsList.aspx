<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master"
 AutoEventWireup="true" CodeBehind="NewTrainYunShunRsList.aspx.cs" 
 Inherits="WebSite.TrainWeb.Train.NewTrainYunShunRs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ImportDataToSystem() {
            var url1 = "ImportDataTool.aspx?kind=5";
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='NewTrainYunShunRsEdit.aspx?num=<%#Eval("num")%>'>
