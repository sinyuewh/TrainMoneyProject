<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="NewTrainQianYinFeeList.aspx.cs" Inherits="WebSite.TrainWeb.Train.QianYeeFeeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ImportDataToSystem() {
            var url1 = "ImportDataTool.aspx?kind=2";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display: none">你当前的位置：</span>财务数据模型-机车牵引费
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
        ...
        <tr>
            <td>
                <jasp:JDataSource ID="Data1" runat="server" JType="Sql" SqlID="select NEWTRAINQIANYINFEE.*,Fee1+Fee2+Fee3 Fee0,zl1+zl2+zl3 zl0 from NEWTRAINQIANYINFEE"
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='NewTrainQianYinFeeDetail.aspx?num=<%#Eval("num")%>'>
