<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="NewTrainXianLuFeeDetail.aspx.cs" Inherits="WebSite.TrainWeb.Train.NewTrainXianLuFeeDetail" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>财务数据模型-线路使用费明细
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td style="height: 600px; vertical-align: top">
                            <!--数据源定义-->
                            <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="NEWTRAINXIANLUFEE"
                                OrderBy="num">
                                <ParaItems>
                            ...
                            <jasp:JDetailView ID="DetailView1" runat="server" DataSourceID="Data1" ControlList="*">
                                <table class="DetailTable" cellspacing="1" cellpadding="0" style="width: 80%; margin-left: 15px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JLabel ID="gongli1" runat="server"></jasp:JLabel>
                                        </td>
                                        <td class="Caption">
                                            本企业应付余额
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JLabel ID="gongli2" runat="server"></jasp:JLabel>
                                        </td>
                                        <td class="Caption">
                                            外企业(国铁)应付余额
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JLabel ID="gongli3" runat="server"></jasp:JLabel>
                                        </td>
                                        <td class="Caption">
                                            外企业(非国铁)应付余额
                                        </td>
