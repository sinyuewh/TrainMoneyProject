                        ...
                        <td>
                            ...
                            <table class="ListTable" cellspacing="1" cellpadding="0" onmouseover="changeto()"
                                ...
                                <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="Train" PageSize="20"
                                    OrderBy="num">
                                    <ParaItems>
                                        <jasp:ParameterItem ParaName="TRAINBIGKIND=0" ParaType="String" DataName="$$EMPTY" />
                                    </ParaItems>
                                </jasp:JDataSource>
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='TrainDetail1.aspx?TRAINNAME=<%#Eval("TRAINNAME")%>'><img src="../images/edt.gif" width="16" height="16" />明细</a> 
