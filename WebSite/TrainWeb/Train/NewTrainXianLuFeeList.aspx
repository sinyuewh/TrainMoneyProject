<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="NewTrainXianLuFeeList.aspx.cs" Inherits="WebSite.TrainWeb.Train.XianLuFeeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ImportDataToSystem() {
            var url1 = "ImportDataTool.aspx?kind=1";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>财务数据模型-线路使用费
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
        ...
        <tr>
            <td>
                <jasp:JDataSource ID="Data1" runat="server" JType="Sql" SqlID="select NEWTRAINXIANLUFEE.*,Fee1+Fee2+Fee3 Fee0,GongLi1+GongLi2+GongLi3 GongLi0 from NEWTRAINXIANLUFEE"
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='NewTrainXianLuFeeDetail.aspx?num=<%#Eval("num")%>'>
