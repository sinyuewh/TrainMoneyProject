<%@ Page Title="新增车次分析" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master"
    AutoEventWireup="true" CodeBehind="NewCheCiFenxiOLD.aspx.cs" Inherits="WebSite.TrainWeb.Fenxi.NewCheCiFenxi" %>
                            ...
                            <table class="DetailTable" cellspacing="1" cellpadding="0" style="width: 99%">
                                <tr>
                                    ...
                                    <td class="Data" style="width: 10%; text-align: left">
                                        <asp:Button ID="Button1" runat="server" ToolTip="点按钮开始分析线路" ForeColor ="Red"
                                          Text="开始分析" OnClientClick="javascript:HideWindow();" />
                                    </td>
                                </tr>
                                <tr id="row2" runat="server">
                                    ...
                                    <td class="Data" style="width: 10%; text-align: left; line-height:150%">
                                        ...
                                        <br />
                                         <asp:Button ID="Button4" runat="server"  Text="既有车次" style="margin-top:3px"
                                            OnClientClick="javascript:SelectOldLine();return false;" ToolTip="选择既有车次的线路" />
                                ...
                                <tr>
                                    ...
                                    <td class="Data" style="width: 13%">
                                        <asp:RadioButtonList ID="cb" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                                    ...
                                    <td class="Data" style="width: 13%">
                                        ...
                                        </asp:RadioButtonList><asp:CheckBox ID="onlygg" runat ="server"  Visible ="false"   />
                                    </td>
                                    <td class="Caption" style="width: 10%">
                                        编组数：
                                    </td>
                                    <td class="Data" style="width: 43%" colspan="2">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                <td rowspan="4" class="Data">
                                                    <asp:DropDownList ID="selTrainType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selTrainType_SelectedIndexChanged">
                                                    </asp:DropDownList>
