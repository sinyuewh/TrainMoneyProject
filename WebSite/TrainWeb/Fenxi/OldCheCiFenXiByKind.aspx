<%@ Page Title="既有车次按分类汇总分析" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master"
    AutoEventWireup="true" CodeBehind="OldCheCiFenXiByKind.aspx.cs" Inherits="WebSite.TrainWeb.Fenxi.OldCheCiFenXiByKind" %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="SearchInfo" runat="server" visible="false">
                                ...
                                <table class="ListTable" cellspacing="1" id="SearchDataTable" cellpadding="0" style="width: 98%;
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server" EnableViewState="true">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                <td class="Data">
                                                    <a class="blue" href="javascript:GoKindFenxi('<%#Eval("traintype") %>');">
                                                    <%#Eval("traintype") %>
                                                </td>
                                ...
                                <div style="margin-top: 10px">
                                    提示：如当月没有显示数据，请先点 <a class ="blue" href="NewTrainLiLunList.aspx">既有车次收支明细</a> 计算需要的数据。
                                    <br />盈亏=收入*当年的税金-支出</div>
                            </div>
                            <!--Report Data-->
                        </td>
