<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="TrainFenXiByKind.aspx.cs" Inherits="WebSite.TrainWeb.Fenxi.TrainFenXiByKind" %>
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" Text="返 回" OnClientClick="javascript:history.back(); return false;" />
                </td>
            </tr>
        </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="96%" style="margin-top: 10px">
                ...
                <asp:Repeater ID="repeater1" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                                <a class="blue" href="JavaScript:GoPicture('<%#Eval("trainname")%>');">
                                    <%#Eval("trainname")%></a>
                                <asp:Label ID="labtrainType" runat="server" Text='<%#Eval("trainname")%>' Visible="false"></asp:Label>
                            </td>
                            <td align="center">
