<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="CorpQuickList.aspx.cs" Inherits="WebSite.TrainWeb.ParamSet.CorpQuickList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>财务数据模型-公司快捷列表
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                ...
                                                <td width="60"> 
                                                    <table width="90%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="STYLE1">
                                                                <div align="center">
                                                                    <a href="CorpQuickDetail.aspx?CORPNAME=-1">新增</a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
        ...
        <tr>
            <td>
                <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="CORPINFO" PageSize="15"
                    OrderBy="CORPNAME">
                </jasp:JDataSource>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="Data1">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="Data">
                                                <a href='CorpQuickDetail.aspx?CORPNAME=<%#Eval("CORPNAME")%>'><img src="../images/edt.gif" width="16" height="16" />明细</a> &nbsp;
                                                <jasp:JLinkButton ID="butDel" AuthorityID="001" runat="server"
                                                       ...
                                                       runat="server" CommandArgument='<%#Eval("CORPNAME")%>' 
                                                       Text='<img src="../images/del.gif"
                                                        width="16" height="16"  />删除'>
                                                    <SimpleActionPara TableName="CORPINFO" ButtonType="DeleteData" />
                                                    <ParaItems>
                                                        <jasp:ParameterItem ParaName="CORPNAME" ParaType="CommandArgument" />
                                                    </ParaItems>
                                                    <ExecutePara  SuccUrl="#" />
                                                </jasp:JLinkButton>
