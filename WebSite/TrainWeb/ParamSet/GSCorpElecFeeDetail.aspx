<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="GSCorpElecFeeDetail.aspx.cs" Inherits="WebSite.TrainWeb.ParamSet.GSCorpElecFeeDetail" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>财务数据模型-客专公司电费明细
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td style="height: 600px; vertical-align: top">
                            <!--数据源定义-->
                            <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="GSCORPELECFEE" OrderBy="NUM">
                                <ParaItems>
                            ...
                            <jasp:JDetailView ID="DetailView1" runat="server" DataSourceID="Data1" ControlList="*">
                                <table class="DetailTable" cellspacing="1" cellpadding="0" style="width: 80%; margin-left: 15px">
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JTextBox ID="RWBUREAU" runat="server" AllowNullValue="false" Caption="铁路局管界"></jasp:JTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="Caption">
                                        ...
                                        <td class="Data">
                                            <jasp:JTextBox ID="NETFEE" runat="server" Caption="接触网使用费" AllowNullValue="false" DataType="Integer"></jasp:JTextBox>
                                        </td>
                                        <td class="Caption">
                                            电费
                                        </td>
                                        <td class="Data">
                                            <jasp:JTextBox ID="ELECFEE" runat="server" AllowNullValue="false" Caption="电费" DataType="Integer"></jasp:JTextBox>
                                        </td>
                                    </tr>            
                                </table>
                            </jasp:JDetailView>
                                ...
                                <asp:UpdatePanel ID="update1" runat="server">
                                    <ContentTemplate>
                                        <jasp:JButton ID="button1" runat="server" AuthorityID="001" Text="提 交" JButtonType="NoJButton" 
                                            ...
                                            <SimpleActionPara TableName="GSCORPELECFEE" ButtonType="UpdateData" AppendFlag="true" />
                                            <ParaItems>
