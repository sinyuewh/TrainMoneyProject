<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="CorpQuickDetail.aspx.cs" Inherits="WebSite.TrainWeb.ParamSet.CorpQuickDetail" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>财务数据模型-公司快捷列表明细
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td style="height: 600px; vertical-align: top">
                            <!--数据源定义-->
                            <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="CORPINFO" OrderBy="CORPNAME">
                                <ParaItems>
                                    <jasp:ParameterItem ParaName="CORPNAME" ParaType="RequestQueryString" IsNullValue="true" />
                                </ParaItems>
                            </jasp:JDataSource>
                            <jasp:JDetailView ID="DetailView1" runat="server" DataSourceID="Data1" ControlList="*">
                                <table class="DetailTable" cellspacing="1" cellpadding="0" style="width: 80%; margin-left: 15px">
                                    <tr>
                                        ...
                                        <td class="Data">
                                            <jasp:JTextBox ID="CORPNAME" runat="server" Caption="公司名称" AllowNullValue="false"></jasp:JTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="Caption">
                                        ...
                                        <td class="Data">
                                            <jasp:JTextBox ID="ABBNAME" runat="server" Caption="公司缩写" AllowNullValue="false"></jasp:JTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="Caption">
                                        ...
                                        <td class="Data">
                                            <jasp:JTextBox ID="WHOLESPELL" runat="server"  Caption ="公司全拼" AllowNullValue="false"></jasp:JTextBox>
                                        </td>
                                    </tr>               
                                </table>
                            </jasp:JDetailView>
                                ...
                                <asp:UpdatePanel ID="update1" runat="server">
                                    <ContentTemplate>
                                        <jasp:JButton ID="button1" runat="server" AuthorityID="001" Text="提 交" JButtonType="NoJButton" 
                                            ...
                                            <SimpleActionPara TableName="CORPINFO" ButtonType="UpdateData" AppendFlag="true" />
                                            <ParaItems>
                                                <jasp:ParameterItem ParaName="CORPNAME" ParaType="RequestQueryString" />
                                            </ParaItems>
