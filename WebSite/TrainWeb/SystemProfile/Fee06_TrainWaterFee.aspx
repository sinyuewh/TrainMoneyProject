<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master"
 AutoEventWireup="true" CodeBehind="Fee06_TrainWaterFee.aspx.cs" 
 Inherits="WebSite.TrainWeb.SystemProfile.Fee06_TrainWaterFee" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>系统配置-列车上水费
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td style="height: 600px; vertical-align: top">
                            <table class="ListTable" cellspacing="1" cellpadding="0" style="width: 60%; margin-left: 15px;
                                ...
                                <tr>
                                    ...
                                    <td class="Data">
                                        <jasp:JTextBox ID="Fee1" runat="server" Text=''></jasp:JTextBox>(元/水站)
                                    </td>
                                </tr>
                                <tr>
                                    <td class="Data">
                                    ...
                                    <td class="Data">
                                        <jasp:JTextBox ID="Fee2" runat="server" Text=''></jasp:JTextBox>(元/水站)
                                    </td>
                                </tr>
                            </table>
