<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true" CodeBehind="Shouru07_SycPerson.aspx.cs" Inherits="WebSite.TrainWeb.SystemProfile.Shouru07_SycPerson" %>
<script runat="server">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display:none">你当前的位置：</span>系统配置-宿营车定员配置
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
