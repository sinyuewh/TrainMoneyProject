                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3">你当前的位置</span>：系统配置-普通车厢重量和成本
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td style="height: 600px; vertical-align: top">
                            ...
                            <div class="ButtonArea" style="width: 100%">
                                ...
                                <div style="text-align: left">
                                    1）普通车根据（硬座、软座、硬卧、软卧）的车辆数*单位维护成本*车底组数计算；<br />
                                    2）电车和餐车的维护成本单独计算（同上）；<br />
                                    3）用车底数（用户输入）*（1+2的成本和）为车辆的日常维护成本；<br />
                                </div>
                                <hr />
                                <div style="text-align: left">
                                    1）普通车根据（硬座、软座、硬卧、软卧）的车厢数*单位定检成本计算*运行里程*2*365*标准
                                    <br />
                                ...
                                <hr />
                                <div style="text-align: left">
                                    1）普通车根据（硬座、软座、硬卧、软卧）的车厢数*单位消耗备用备品成本；<br />
                                    2）电车的单位消耗备用备品成本；<br />
