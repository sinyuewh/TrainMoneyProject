...
{
    public partial class Fee07_PersonGZAndFuJiaFee : System.Web.UI.Page
    {
        ...
        void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in this.Repeater1.Items)
            {
                ...
                foreach (String m in arr1)
                {
                    ...
                    {
                        DropDownList t1 = item.FindControl(m) as DropDownList;
                        if (t1 != null)
                        {
                            data1[m] = t1.SelectedValue;
                        }
                    }
                }
                tab1.EditData(data1, condition);
