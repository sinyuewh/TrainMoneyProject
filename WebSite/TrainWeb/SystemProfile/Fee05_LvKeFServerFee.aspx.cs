...
{
    public partial class Fee05_LvKeFServerFee : System.Web.UI.Page
    {
        ...
        void button1_Click(object sender, EventArgs e)
        {
            ...
            condition.Add(new SearchField("StrID", "普通列车旅客服务费标准"));
            Dictionary<String, object> data1 = new Dictionary<string, object>();
            data1["StrText"] = this.Fee1.Text;
            bu1.UpdateData(condition, data1);

            condition.Clear();
            condition.Add(new SearchField("StrID", "动车旅客服务费标准"));
