<%@ Page Title="" Language="C#" MasterPageFile="~/TrainWeb/TrainWeb.Master" AutoEventWireup="true"
    CodeBehind="Shouru06_PiaoJia2.aspx.cs" Inherits="WebSite.TrainWeb.SystemProfile.Shouru06_PiaoJia2" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1">
                                                    <span class="STYLE3" style="display: none">你当前的位置：</span>系统配置-新型空调车票价参考表
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td>
                            ...
                            <table class="ListTable" cellspacing="1" cellpadding="0" onmouseover="changeto()"
                                ...
                                <jasp:JDataSource ID="Data1" runat="server" JType="Table" SqlID="ticketprice" PageSize="13"
                                    OrderBy="num">
                                    <ParaItems>
                                        <jasp:ParameterItem ParaName="traintype='2'" ParaType="String" DataName="$$empty" />
                                    </ParaItems>
                                </jasp:JDataSource>
